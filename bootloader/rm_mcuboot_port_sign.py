...
boot_project_root = os.path.abspath(os.path.dirname(__file__))
...
# Verify requirements
with open(boot_project_root + '/mcu-tools/MCUboot/scripts/requirements.txt') as f:
...
if '-v' in sys.argv or '--version' in sys.argv:
    message_str = 'Version passed from command line'
...
sys.path.append(boot_project_root + '/mcu-tools/MCUboot/scripts')
